...
def analyze_resistance_patterns(sno, stype, days ,resistance_threshold=0.05):
    """
    分析並顯示阻力位測試模式
    """
...
# 簡化版本 - 更穩定的實現
def simple_resistance_pattern(symbol, period="1y", lookback_days=30, resistance_threshold=0.02):
    """
    簡化版本的三次測試高位模式識別
    """
    # 下載股票資料
