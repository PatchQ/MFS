...
if __name__ == '__main__':
    ...
    YFSignal("XNCM","BOSS2~BOSSB~BOSSTP1~BOSSTP2~BOSSCL1~BOSSCL2","60")    
    YFSignal("XNGS","BOSS2~BOSSB~BOSSTP1~BOSSTP2~BOSSCL1~BOSSCL2","60")
    YFSignal("XNYS","BOSS2~BOSSB~BOSSTP1~BOSSTP2~BOSSCL1~BOSSCL2","60")    

    # YFSignal("XASE","T1_100","30")
    # YFSignal("XNMS","T1_100","30")
    # YFSignal("XNCM","T1_100","30")
    # YFSignal("XNGS","T1_100","30")
    # YFSignal("XNYS","T1_100","30")

    # YFSignal("XASE","BOSSB~BOSSTP1~BOSSTP2~BOSSTP3~BOSSCL1~BOSSCL2",DAYS,SDATE,EDATE)
    # YFSignal("XNMS","BOSSB~BOSSTP1~BOSSTP2~BOSSTP3~BOSSCL1~BOSSCL2",DAYS,SDATE,EDATE)
    # YFSignal("XNCM","BOSSB~BOSSTP1~BOSSTP2~BOSSTP3~BOSSCL1~BOSSCL2",DAYS,SDATE,EDATE)
    # YFSignal("XNGS","BOSSB~BOSSTP1~BOSSTP2~BOSSTP3~BOSSCL1~BOSSCL2",DAYS,SDATE,EDATE)
    # YFSignal("XNYS","BOSSB~BOSSTP1~BOSSTP2~BOSSTP3~BOSSCL1~BOSSCL2",DAYS,SDATE,EDATE)
